...
function defaultConfigFor(kind, language) {
  ...
  if (kind === "business_card") {
    return {
      ...
      elements: [
        ...
        { id: "company", type: "text", label: p("نام شرکت", "اسم الشركة", "Şirket adı", "Company name"), text: "VITALIX ERP", x: 18, y: 18, w: 170, h: 26, fontSize: 15, color: "#22d3ee", bg: "transparent", border: "transparent", radius: 0, align: "right", bold: true },
  ...
  return {
    ...
    elements: [
      ...
      { id: "company", type: "text", label: p("نام شرکت", "اسم الشركة", "Şirket adı", "Company name"), text: "VITALIX ERP", x: 300, y: 35, w: 255, h: 30, fontSize: 18, color: "#0891b2", bg: "transparent", border: "transparent", radius: 0, align: "left", bold: true },
